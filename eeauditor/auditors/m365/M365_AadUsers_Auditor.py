...
def m365_aad_user_mfa_check(cache: dict, awsAccountId: str, awsRegion: str, awsPartition: str, tenantId: str, clientId: str, clientSecret: str, tenantLocation: str) -> dict:
    """
...
@registry.register_check("m365.aadusers")
def m365_aad_user_phishing_resistant_mfa_check(cache: dict, awsAccountId: str, awsRegion: str, awsPartition: str, tenantId: str, clientId: str, clientSecret: str, tenantLocation: str) -> dict:
    """
...
@registry.register_check("m365.aadusers")
def m365_aad_user_active_identity_protection_risk_detection_check(cache: dict, awsAccountId: str, awsRegion: str, awsPartition: str, tenantId: str, clientId: str, clientSecret: str, tenantLocation: str) -> dict:
    """
...
@registry.register_check("m365.aadusers")
def m365_aad_user_active_identity_protection_risky_user_check(cache: dict, awsAccountId: str, awsRegion: str, awsPartition: str, tenantId: str, clientId: str, clientSecret: str, tenantLocation: str) -> dict:
    """
