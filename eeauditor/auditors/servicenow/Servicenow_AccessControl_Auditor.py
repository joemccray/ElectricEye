...
def servicenow_sspm_soap_content_type_checking_check(cache: dict, awsAccountId: str, awsRegion: str, awsPartition: str):
    ...
    # Name of the property to evaluate against
    evalTarget = "glide.soap.require_content_type_xml"
    # Get cached props
    sysPropCache = get_servicenow_sys_properties(cache)
    ...
    if propertyValue != "true":
        finding = {
            ...
            "Remediation": {
                "Recommendation": {
                    "Text": "For more information refer to the SOAP content type checking (instance security hardening) section of the Servicenow Product Documentation.",
                    "Url": "https://docs.servicenow.com/bundle/utah-platform-security/page/administer/security/reference/soap-content-type-checking.html",
                }
            },
            "ProductFields": {
                "ProductName": "ElectricEye",
...
def servicenow_sspm_unload_request_enforce_basic_auth_check(cache: dict, awsAccountId: str, awsRegion: str, awsPartition: str):
    ...
    # Name of the property to evaluate against
    evalTarget = "glide.basicauth.required.unl"
    # Get cached props
    sysPropCache = get_servicenow_sys_properties(cache)
    ...
    if propertyValue != "true":
        finding = {
            ...
            "Remediation": {
                "Recommendation": {
                    "Text": "For more information refer to the Unload request authorization (instance security hardening) section of the Servicenow Product Documentation.",
                    "Url": "https://docs.servicenow.com/bundle/utah-platform-security/page/administer/security/reference/unload-request-authorization.html",
                }
            },
            "ProductFields": {
                "ProductName": "ElectricEye",
